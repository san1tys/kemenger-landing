...
const Services = () => {
  return (
    <section id="advantages" className="w-full flex flex-col xl:ml-[300px] px-4 max-w-[80%] relative">
      <h1 className="font-semibold mt-24 text-3xl" >Тренинг <span className="underline">KEMENGER</span> - это уникальный опыт самопознания, <br></br> который за 4 насыщенных дня поможет тебе:</h1>
